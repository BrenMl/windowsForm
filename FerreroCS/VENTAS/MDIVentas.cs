...
namespace FerreroCS.VENTAS
{
    public partial class MDIVentas : Form
    {
        ...
        public MDIVentas()
        {
            ...
            GeneraMenu(ref menuStrip, ref tsCatalogos, ModUsuario.SessionIdUsuario, (int)ClsEnumeradores.Modulos.Ventas);
        ...
        private void MDICatalogos2_Load(object sender, EventArgs e)
        {
        ...
        private void MDICatalogos2_Resize(object sender, EventArgs e)
        {
